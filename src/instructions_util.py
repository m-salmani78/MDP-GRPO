...
def _ensure_punkt_resources():
  # Make sure both resources exist (NLTK >= 3.8 uses punkt_tab too)
...
def _get_sentence_tokenizer():
  ...
  # Either path works; this one is conventional
